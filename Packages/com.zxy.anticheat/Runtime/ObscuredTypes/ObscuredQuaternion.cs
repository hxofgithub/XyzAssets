...
namespace XyzAniCheat.Runtime.ObscuredTypes
{
    ...
    public struct ObscuredQuaternion
    {
        ...
        private Quaternion InternalDecrypt()
        {
            ...
            if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && !CompareQuaternionsWithTolerance(value, fakeValue))
            {
        ...
        {
            var epsilon = AniCheatDetector.Instance.quaternionEpsilon;
