    ...
    public struct ObscuredVector2
    {
        ...
        public float x
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.x) > AniCheatDetector.Instance.vector2Epsilon)
                {
        ...
        public float y
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.y) > AniCheatDetector.Instance.vector2Epsilon)
                {
                    AniCheatDetector.Instance.OnCheatingDetected();
                }
                return decrypted;
        ...
        {
            var epsilon = AniCheatDetector.Instance.vector2Epsilon;
