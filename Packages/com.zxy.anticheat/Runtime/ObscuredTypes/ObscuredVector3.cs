...
namespace XyzAniCheat.Runtime.ObscuredTypes
{
    [Serializable]
    public struct ObscuredVector3
    {
        ...
        private ObscuredVector3(Vector3 value)
        {
            ...
            var detectorRunning = AniCheatDetector.Instance.ExistsAndIsRunning;
        ...
        public ObscuredVector3(float x, float y, float z)
        {
            ...
            if (AniCheatDetector.Instance.ExistsAndIsRunning)
            {
                fakeValue.x = x;
                fakeValue.y = y;
                fakeValue.z = z;
        ...
        public float x
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.x) > AniCheatDetector.Instance.vector3Epsilon)
                {
                    AniCheatDetector.Instance.OnCheatingDetected();
                }
                return decrypted;
            }
        ...
        public float y
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.y) > AniCheatDetector.Instance.vector3Epsilon)
                {
                    AniCheatDetector.Instance.OnCheatingDetected();
                }
                return decrypted;
        ...
        public float z
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.z) > AniCheatDetector.Instance.vector3Epsilon)
                {
                    AniCheatDetector.Instance.OnCheatingDetected();
                }
                return decrypted;
        ...
        private Vector3 InternalDecrypt()
        {
            ...
            if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && !CompareVectorsWithTolerance(value, fakeValue))
            {
                AniCheatDetector.Instance.OnCheatingDetected();
            }
        ...
        {
            var epsilon = AniCheatDetector.Instance.vector3Epsilon;
