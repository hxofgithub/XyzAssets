    ...
    public struct ObscuredVector3Int
    {
        ...
        public int x
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.x) > 0)
                {
        ...
        public int y
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.y) > 0)
                {
                    AniCheatDetector.Instance.OnCheatingDetected();
                }
                return decrypted;
        ...
        public int z
        {
            get
            {
                ...
                if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue.z) > 0)
                {
                    AniCheatDetector.Instance.OnCheatingDetected();
                }
                return decrypted;
        ...
        private Vector3Int InternalDecrypt()
        {
            ...
            if (AniCheatDetector.Instance.ExistsAndIsRunning && fakeValueActive && value != fakeValue)
            {
                AniCheatDetector.Instance.OnCheatingDetected();
            }
